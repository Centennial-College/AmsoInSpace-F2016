...
module objects {
    export class Player extends objects.GameObject {
        ...
        private _oldPosition: objects.Vector2
        ...
        public start(): void {
            ...
            this._oldPosition = this.position = new Vector2(this.x, this.y);
        ...
        private _showPlayerMoveAnimation(): void {
        ...
        public update(): void {
            ...
            // old position
            this._oldPosition = new Vector2(this.x, this.y)
